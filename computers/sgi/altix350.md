...
My Altix 350 system consists of 8 compute bricks and 1 NL4R router. I purchased the system as a maxed out 16 brick setup, but some had small issues like failed power supplies or failed memory. 
I have no need for a full 16 brick system, so I sold some bricks for parts and plan to keep 8. 

Currently the NL4R router is broken with a bad power supply. I will document the process of replacing it when I get around to it.
...
1. Add support for SN2 back into the Linux kernel - [Done!](/blog/008-sn2-linux.html)  
2. Create an easy to install iso of [T2-SDE Linux](https://t2linux.com/)  - [Done!](/blog/010-sn2-t2-install.html)  
3. Get the `radeon` driver working with a PCI (or maybe even PCI-E) graphics card - [Done!](/blog/009-sn2-gpu.html)  
